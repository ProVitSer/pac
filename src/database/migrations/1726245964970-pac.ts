...
export class Pac1726245964970 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pac_connector_grpc_server" ADD CONSTRAINT "FK_8bd40f7eb1ec0776d8d25f710b2" FOREIGN KEY ("clien_id") REFERENCES "client"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
