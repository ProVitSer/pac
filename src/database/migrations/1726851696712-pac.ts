...
export class Pac1726851696712 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "tg_users" ("id" SERIAL NOT NULL, "user_name" character varying NOT NULL, "extension" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_9ca7cb460931bb8da0685e39fc8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tg_config" ("id" SERIAL NOT NULL, "is_test" character varying NOT NULL, "chat_id" character varying NOT NULL, "message" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "client_id" integer, CONSTRAINT "UQ_3be3fb7d1cfbf5814e661a27b4e" UNIQUE ("is_test"), CONSTRAINT "UQ_d6c6a7ddf31152ccb916abda171" UNIQUE ("chat_id"), CONSTRAINT "PK_a02b8f031ca182904024e270af7" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tg_config_tg_users_tg_users" ("tgConfigId" integer NOT NULL, "tgUsersId" integer NOT NULL, CONSTRAINT "PK_f05b7aa6ceefd6717c4a6e9e9f5" PRIMARY KEY ("tgConfigId", "tgUsersId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "tg_config_tg_users_tg_users" ADD CONSTRAINT "FK_db71f8679386b84d9ccdfe41f3b" FOREIGN KEY ("tgConfigId") REFERENCES "tg_config"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "tg_config_tg_users_tg_users" ADD CONSTRAINT "FK_8cfd4cdc035baac89b6f1881e19" FOREIGN KEY ("tgUsersId") REFERENCES "tg_users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
