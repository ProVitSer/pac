...
describe('ClientsService', () => {
    ...
    it('should create a client', async () => {
        ...
        const createUser = {
            ...
            contactPersonName: clients[0].contactPersonName,
            companyPhone: clients[0].phone,
            companyEmail: clients[0].email,
        };
    ...
    it('should return a client by id', async () => {
        ...
        const result = await service.getClientByClientId(clients[1].clientId);
    ...
    it('should throw an error if trying search not exists client', async () => {
        ...
        await expect(service.getClientByClientId(clients[1].clientId)).rejects.toThrow(ClientNotFoundException);
    });
    ...
    it('should throw an error if trying to update a non-existent client', async () => {
        ...
        await expect(service.updateClient(clients[2].clientId, { companyName: clients[1].companyName })).rejects.toThrow(
    ...
    it('should delete a client', async () => {
        ...
        await service.deleteClient(clients[1].clientId);
    ...
    it('should throw an error if trying to delete a non-existent client', async () => {
        ...
        await expect(service.deleteClient(clients[2].clientId)).rejects.toThrow(ClientNotFoundException);
    });
});
