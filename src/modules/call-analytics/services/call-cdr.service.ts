    ...
    public async getCallData(callId: number): Promise<CdrData[]> {
        ...
        cdrs.map((cdr: PbxCallStatistics) =>
            formattedCdrs.push({
                ...
                sourceDn: cdr.sourceDn,
                sourceCallerId: cdr.sourceCallerId,
                destinationDisplayName: cdr.destinationDisplayName,
                destinationDn: cdr.destinationDn,
                destinationCallerId: cdr.destinationCallerId,
